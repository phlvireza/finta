import '../../../core/utils/budget_pace.dart';
export '../../../core/utils/budget_pace.dart';
...
/// screen and the health summary so all three stay visually consistent.
          ...
          children: [
            ...
            if (showPaceMarker)
              Positioned.fill(
                child: Align(
                  alignment: Alignment(
                    (timeElapsedFraction.clamp(0.0, 1.0) * 2) - 1,
                    0,
                  ),
                  child: Container(
                    width: 2,
